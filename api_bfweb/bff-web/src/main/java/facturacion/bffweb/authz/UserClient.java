...
public interface UserClient {
    ...
    @PutMapping("/{id}/")
    UserDTO update(@RequestHeader("Authorization") String authorizationHeader, @PathVariable("id") Long id,
            UserDTO entity);

    @GetMapping("/hasAuthority/")
    public ResponseEntity<String> hasAuthority(@RequestHeader("Authorization") String authorizationHeader,
